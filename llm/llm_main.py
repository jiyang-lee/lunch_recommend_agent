...
from db.menu_db import DEFAULT_MENU_CSV, load_menu_context
...
def main() -> int:
    ...
    menu_csv_arg = Path(args.menu_csv)
    if menu_csv_arg.is_absolute():
        menu_csv_path = menu_csv_arg
    else:
        menu_csv_path = project_root / menu_csv_arg
